namespace _01.Red_Black_Tree.Tests
{
    ...
    public class RedBlackThreeTests
    {
        ...
        public void TestMultDelete()
        {
            ...
            this.RedBlackTree.EachInOrder(actualOutput.Add);

            Assert.AreEqual(expectedOutput.Count, this.RedBlackTree.Count);
        ...
        {
            var searchedEl = this.RedBlackTree.Search("M");

            Assert.IsTrue(searchedEl.Contains("M"));
        }
    }
}
