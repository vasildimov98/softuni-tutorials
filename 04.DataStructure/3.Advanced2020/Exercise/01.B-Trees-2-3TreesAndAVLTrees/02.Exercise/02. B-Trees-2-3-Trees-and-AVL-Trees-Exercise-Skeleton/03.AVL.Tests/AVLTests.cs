...
namespace _03.AVL.Tests
{
    ...
    public class AVLTests
    {
        ...
        public void InsertNumbers()
        {
            ...
            // Act
            var numbers = new[] { 50, 30, 35, 20, 10, 70, 33, 40, 32 };
            ...
            // Assert
            Assert.AreEqual(4, avl.Root.Height);
            Assert.AreEqual(35, avl.Root.Value);
            Assert.AreEqual(20, avl.Root.Left.Value);
            Assert.AreEqual(3, avl.Root.Left.Height);
            Assert.AreEqual(50, avl.Root.Right.Value);
            Assert.AreEqual(2, avl.Root.Right.Height);
        }

        [Test]
        public void DeleteMethodsShouldDeleteTheElementThatWasGiven()
        {
            // Arrange
            AVL<int> avl = new AVL<int>();
            var numbers = new[] { 50, 30, 35, 20, 10, 70, 33, 40, 32 };
