namespace Tree.Tests
{
    ...
    public class TreeTests
    {
        ...
        [Test]
        public void TreeDeepestLeftmostNodeShouldWorkCorrectly1()
        {
            string[] input = new string[]
            {
                "7 19",
            ...
            Assert.AreEqual(53, deepestNode.Key);
        }
        ...
        [Test]
        public void TreeLeftmostLongestPathShouldWorkCorrectly1()
        {
            string[] input = new string[]
           {
                "7 19",
            ...
            int[] expectedPath = new int[] { 7, 14, 6, 53 };
            List<int> longestLeftmostPath = this._tree.GetLongestPath();
